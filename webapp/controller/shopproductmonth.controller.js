sap.ui.define([
	...
	return Controller.extend("portalnew.controller.shopproductmonth", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf portalnew.view.shopproductmonth
		 */
		//	onInit: function() {
		//
		//	},
		...
		onAfterRendering: function() {
			...
			var otable = this.getView().byId("productorderlist");
			...
			odata.read("/productionlistSet" + uri + "", {
		...
		onrow: function(oEvent) {
			...
			if (!this.oDialog) {
				this.oDialog = sap.ui.xmlfragment("portalnew.Frangments.productionorder", this);
			...
			oModel.read("/productiondetailSet('" + ordernum + "')", {
				success: function(oData, response) {
		...
		onsearch: function(oEvent) {
			var oList = this.getView().byId("productorderlist");
			...
			var ordernumberFilter = new sap.ui.model.Filter("OrderNumber", sap.ui.model.FilterOperator.Contains, sValue);
